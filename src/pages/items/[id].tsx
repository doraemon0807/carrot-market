        ...
        <div className="mb-8">
          ...
          <div className="mt-10">
            ...
            <p className="my-6 text-gray-700">
              ...
              Corporis delectus, impedit nesciunt accusantium voluptatibus
              tempore odio deleniti, earum aspernatur aut rerum, totam corrupti
              perferendis at! Iusto facilis ex nostrum odit?
            </p>
