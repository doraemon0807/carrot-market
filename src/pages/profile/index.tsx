      ...
      <div className="mt-12">
        ...
        <div className="mt-4 text-sm text-gray-600">
          <p>
            ...
            harum exercitationem accusamus nisi maiores quisquam repellendus
            obcaecati quo expedita ipsam distinctio eligendi totam quod, quia
            adipisci nesciunt a neque.
          </p>
        </div>
      </div>
    </div>
